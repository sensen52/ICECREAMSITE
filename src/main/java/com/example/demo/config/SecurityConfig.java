	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			.authorizeRequests()
				...
				.antMatchers("/","/public","/th/3ice/join","/th/3ice/login","/sms/send","/th/3ice/index","/th/3ice/myPage","/th/3ice/update","/th/3ice/withdraw").permitAll()// hasRole을 사용시 기본적으로 Role_ 이 제공된다
